...
**Управление маршрутизацией Podkop на OpenWrt, сайт за сайтом**
...
**Podkop Manager** позволяет выбирать, какие сайты идут через **Podkop**, а какие остаются напрямую, прямо из текущей вкладки браузера.

Расширение определяет активный сайт, связанные домены запросов и публичные IPv4-адреса, а затем синхронизирует выбранные правила со списками Podkop на OpenWrt.
